...
if __name__ == '__main__':
    ...
    train_set1 = (dataset0[:int(len(dataset0)*x1)]
                  + dataset1[:int(len(dataset1)*x1)]
                  + dataset2[:int(len(dataset2)*x1)])
    train_X1 = [row[:-1] for row in train_set1]
    train_Y1 = [row[-1] for row in train_set1]


    test_set = (dataset0[int(len(dataset0)*x2):]
                 + dataset1[int(len(dataset1)*x2):]
                 + dataset2[int(len(dataset2)*x2):])
    ...
    train_set2 = (dataset0[int(len(dataset0) * x1):int(len(dataset0) * x2)]
                  + dataset1[int(len(dataset1) * x1):int(len(dataset1) * x2)]
                  + dataset2[int(len(dataset2) * x1):int(len(dataset2) * x2)])
    ...
    train_set3 = (dataset0[:int(len(dataset0) * x2)]
                  + dataset1[:int(len(dataset1) * x2)]
                  + dataset2[:int(len(dataset2) * x2)])
    train_X3 = [row[:-1] for row in train_set3]
    train_Y3 = [row[-1] for row in train_set3]
    ...
    accuracy = 0
    for real, pred1, pred2, pred3 in zip(test_Y, predictions1, predictions2, predictions3):
        if real == pred1 == pred2 or real == pred2 == pred3 or real == pred3 == pred1:
            accuracy += 1

    print(f'Tochnost: {accuracy/len(test_Y)}')